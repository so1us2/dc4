...
public class GameService {
  ...
  /**
   * Handles client request for game:move protocol.
   */
  public void handleMove(GameMessage message) {
    GameHandler gameHandler = gameHandlers.get(message.gameUUID);
    gameHandler.processMoveRequest(Move.fromJson(message.data.getJson("move")));
  }
